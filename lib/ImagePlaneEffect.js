...
export default class ImagePlaneEffect {
	...
	_init() {
		...
		this.imgs.forEach((img) => {
			...
			const plane = { img, mesh, program, texture };
	...
	_loop() {
		...
		for (const plane of this.planes) {
			...
			// Eased cursor in this plane's local uv (y flipped to GL space). Computed
			// even outside the plane so the circle lens crosses plane boundaries.
